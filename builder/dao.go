...
func buildInsertOnDuplicateMulti(table string, data []map[string]any, update []string) (string, []any, error) {
...
func resolveUpdate(update map[string]any) (sets string, vals []any) {
